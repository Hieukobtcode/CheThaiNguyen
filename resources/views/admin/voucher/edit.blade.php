                ...
                <form action="{{ route('voucher.update', $voucher->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ten_khuyen_mai" id="ten_khuyen_mai"
                            ...
                            value="{{ old('ten_khuyen_mai', $voucher->ten_khuyen_mai) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ma" id="ma"
                            class="form-control @error('ma') is-invalid @enderror" value="{{ old('ma', $voucher->ma) }}"
                            required>
                        @error('ma')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="gia_tri" id="gia_tri"
                            ...
                            value="{{ old('gia_tri', $voucher->gia_tri) }}" required>
                        @error('gia_tri')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="so_luong" id="so_luong"
                            ...
                            value="{{ old('so_luong', $voucher->so_luong) }}" required>
                        @error('so_luong')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="bat_dau" id="bat_dau"
                            class="form-control @error('bat_dau') is-invalid @enderror"
                            value="{{ old('bat_dau', $voucher->bat_dau ? \Carbon\Carbon::parse($voucher->bat_dau)->format('Y-m-d\TH:i') : '') }}">
                        @error('bat_dau')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="ket_thuc" id="ket_thuc"
                            ...
                            value="{{ old('ket_thuc', $voucher->ket_thuc ? \Carbon\Carbon::parse($voucher->ket_thuc)->format('Y-m-d\TH:i') : '') }}">
                        @error('ket_thuc')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
