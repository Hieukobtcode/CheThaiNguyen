    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0">Thêm cấp bậc thành viên</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('cap_bac.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="diem_toi_thieu" id="diem_toi_thieu" class="form-control"
                            value="{{ old('diem_toi_thieu') }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="ti_le_tich_diem" id="ti_le_tich_diem"
                            class="form-control" value="{{ old('ti_le_tich_diem') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="uu_dai" class="form-label">Ưu đãi</label>
                        <textarea name="uu_dai" id="uu_dai" class="form-control" rows="3">{{ old('uu_dai') }}</textarea>
                    </div>
