                ...
                <form action="{{ route('san_pham.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ten" id="ten"
                            class="form-control @error('ten') is-invalid @enderror" value="{{ old('ten') }}" required>
                        @error('ten')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('mo_ta') is-invalid @enderror" id="mo_ta" name="mo_ta" rows="6"
                            placeholder="Nhập mô tả chi tiết sản phẩm">{{ old('mo_ta') }}</textarea>
                        @error('mo_ta')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="gia" id="gia"
                            class="form-control @error('gia') is-invalid @enderror" value="{{ old('gia') }}" required>
                        @error('gia')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
