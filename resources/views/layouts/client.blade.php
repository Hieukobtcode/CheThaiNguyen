...
<head>
    ...
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/bootstrap/bootstrap.4.3.1.min.css?v=5" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/fontAwesome/font-awesome-5.12.0.min.css?v=5"
        type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/jqueryUI/jqui.css?v=5" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/validationEngine.jquery.css?v=5" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/font.css?v=5" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/css/appLib.css" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/tp/T0239/css/slick.css?v=69" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/tp/T0239/css/font.css?v=69" type="text/css">
    <link rel="stylesheet" href="https://web.nvnstatic.net/tp/T0239/css/style.css?v=69" type="text/css">
    ...
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/bootstrap/bootstrap.4.3.1.min.js?v=32"></script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/bootstrap/bootstrap.bundle.min.js?v=32"></script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/jquery/jquery-ui-1.10.3.custom.min.js?v=32">
    </script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/jquery/jquery.number.min.js?v=32"></script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/jquery/jquery.validationEngine.js?v=32"></script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/js/jquery/jquery.validationEngine-vi.js?v=32">
    </script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/tp/T0239/js/slick.min.js?v=17"></script>
    <script defer type="text/javascript" src="https://web.nvnstatic.net/tp/T0239/js/main.js?v=17"></script>
    ...
    <script src="https://pos.nvnstatic.net/cache/location.vn.js?v=20250706_2" defer></script>
    <style>
        figure.image {
            clear: both;
            display: table;
                            ...
                            <ul class="nav menu-pc justify-content-center">
                                <li class="lv1 cate_hover">
                                    <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative"
                                        href="/accessories-pc570536.html" title="Accessories">Accessories</a><i
                                        ...
                                        <li class="lv2">
                                            ...
                                            <ul class="sub-menu-2">
                                                ...
                                                <li class="lv3">
                                                    ...
                                                    <ul class="sub-menu-3">
                                                        <li class="lv4"><a href = "/dep-nike-pc571349.html">Dép
                                                                Nike </a></li>
                                                        <li class="lv4"><a href = "/dep-adidas-pc571350.html">Dép
                                                                Adidas </a></li>
                                                        <li class="lv4"><a href = "/dep-mlb-pc571351.html">Dép MLB
                                                            </a></li>
                                                    </ul>
                                                </li>
                                                <li class="lv3">
                                ...
                                <li class="lv1 cate_hover">
                                    <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative"
                                        href="/giay-pc570537.html" title="Giày">Giày</a><i
                                        class="fas fa-caret-down"></i>
                                    <ul class="wrap">
                                        <li class="lv2">
                                            ...
                                            <ul class="sub-menu-2">
                                                <li class="lv3">
                                                    <a class="tp_menu_item" href = "/puma-mule-pc570898.html">Puma
                                                        Mule
                                                    </a>
                                                </li>
                                                <li class="lv3">
                                        ...
                                        <li class="lv2">
                                            ...
                                            <ul class="sub-menu-2">
                                                <li class="lv3">
                                                    ...
                                                    <ul class="sub-menu-3">
                                                        <li class="lv4"><a href = "/air-max-1-pc570902.html">Air
                                                                Max 1 </a></li>
                                                        <li class="lv4"><a href = "/air-max-90-pc570903.html">Air
                                                                Max 90 </a></li>
                                                    </ul>
                                                </li>
                                                <li class="lv3">
                                ...
                                <li class="lv1 cate_hover">
                                    <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative"
                                        href="/ki-gui-pc571352.html" title="Kí gửi">Kí gửi</a>
                                </li>
                                <li class="lv1 cate_hover">
                                    <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative"
                                        href="/quan-ao-pc571353.html" title="Quần áo">Quần áo</a>
                                </li>
                                <li class="lv1 cate_hover"><a
                                        class="d-inline-block font-weight-bold position-relative tp_menu"
                                        href="/news" title="Tin tức">Tin tức</a></li>
                                <li class="lv1 cate_hover"><a
                                        class="d-inline-block font-weight-bold position-relative tp_menu"
                                        href="/promotion" title="Khuyến mại">Khuyến mại</a></li>
                        ...
                        <div class="col-6 form-login">
                            ...
                            <form class="login-form">
                                <ul class="m-0 p-0">
                                    ...
                                    <li><input class="text-uppercase font-weight-bold" id="btn-register"
                                            type="submit" value="Đăng nhập"></li>
                                    <li class="login-social loginFb" rel="nofollow">
                                        <a href="/user/fbsignin?redirect=/"> <i class="fab fa-facebook-f"></i> Đăng
                                            nhập bằng Facebook</a>
                                    </li>
                                    <li class="login-social loginGg" rel="nofollow">
                                        <a href="/user/ggsignin"><i class="fab fa-google"></i> Đăng nhập bằng
                                            Google</a>
                                    </li>
                                </ul>
                            </form>
                                ...
                                <ul class="m-0 p-0">
                                    <li>
                                        ...
                                        <input name="fullName" type="text"
                                            class="txtFullName validate[required]">
                                    </li>
                                    <li class="li-email">
                                        <label class="font-weight-bold">Địa chỉ email *</label>
                                        <input name="email" type="text" class="txtEmail validate[required]">
